...
import { ListPostsQuery, GetPostQuery, Post, CreateCommentInput, CreateCommentMutation, Comment } from "../../API";
...
export default function IndividualPost({ post }: Props): ReactElement {
  ...
  return (
    <Container maxWidth="md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} autoComplete="off" style={{ marginTop: 32, marginBottom: 32 }}>
